  ...
  head: () => ({
    meta: [
      { title: "Episodes | Her Game, Her Voice" },
      {
        name: "description",
        content:
          "Every story deserves to be heard. Stream all episodes of Her Game, Her Voice and subscribe wherever you listen to podcasts.",
      },
      { property: "og:title", content: "Episodes | Her Game, Her Voice" },
      {
        property: "og:description",
        content: "Every story deserves to be heard — stream all episodes and subscribe.",
      },
      ...
      <section className="bg-background py-16 sm:py-20">
        <div className="mx-auto max-w-[900px] px-4 sm:px-6">
          <LazyIframe
            ...
            title="Her Game, Her Voice — all episodes on Spotify"
            height={500}
